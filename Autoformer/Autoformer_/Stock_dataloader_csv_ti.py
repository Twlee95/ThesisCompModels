...
class stock_csv_read:
    ...
    def data_loader(self):
        stock_data = pd.read_csv("C:/Users/lab/Desktop/Autoformer/data/kdd17/price_long_50/" + self.data ,header=0)
        modality2_data = pd.read_csv(r"C:\Users\lab\Desktop\Autoformer\data\kdd17\modality2.csv",header=0)
        modality3_data = pd.read_csv(r"C:\Users\lab\Desktop\Autoformer\data\kdd17\modality3.csv",header=0)
